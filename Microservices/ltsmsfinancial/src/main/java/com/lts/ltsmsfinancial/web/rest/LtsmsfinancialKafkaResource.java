...
@RestController
@RequestMapping("/api/ltsmsfinancial-kafka")
public class LtsmsfinancialKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LtsmsfinancialKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public LtsmsfinancialKafkaResource(KafkaProperties kafkaProperties) {
