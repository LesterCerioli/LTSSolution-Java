...
@RestController
@RequestMapping("/api/ltsmscore-kafka")
public class LtsmscoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LtsmscoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public LtsmscoreKafkaResource(KafkaProperties kafkaProperties) {
